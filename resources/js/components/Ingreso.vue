    ...
    export default {
        ...
        methods : {
            ...
            validarIngreso()
            {
                ...
                if (!this.num_comprobante) this.errorMostrarMsjIngreso.push("Seleccione el numero de comprobante");
                if (!this.impuesto) this.errorMostrarMsjIngreso.push("Ingreso el impuesto de la compra");
            ...
            desactivarIngreso(id)
            {
                ...
                swalWithBootstrapButtons({
                  title: 'Estas seguro que desea anular este Ingreso?',                
                  type: 'warning',
