                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                        <select class="form-control col-md-3" v-model="criterio">
                                          <option value="nombre">Tipo Comprobante</option>
                                          <option value="num_documento">Numero Comprobante</option>
                                          <option value="email">Fecha-Hora</option>
                                        </select>
                    ...
                    <template v-else-if="listado==0">
                        <div class="card-body">
                            ...
                            <div class="form-group row border">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label>Descuento<span style="color:red;" v-show="cantidad==0">(* Ingrese)</span></label>
                                    ...
                                    <table class="table table-bordered table-striped table-sm">
                                        ...
                                        <tbody v-if="arrayDetalle.length">
                                            <tr v-for="(detalle,index) in arrayDetalle" :key="detalle.id">
                                                <td>
                                                    <button @click="eliminarDetalle(index)" type="button" class="btn btn-danger form-control btn-sm">
    ...
    export default {
        ...
        methods : {
            ...
            validarVenta()
            {
                ...
                if (!me.num_comprobante) me.errorMostrarMsjVenta.push("Seleccione el numero de comprobante");
                if (!me.impuesto) me.errorMostrarMsjVenta.push("Ingreso el impuesto de la compra");
            ...
            desactivarVenta(id)
            {
                ...
                swalWithBootstrapButtons({
                  title: 'Estas seguro que desea anular esta venta?',                
                  type: 'warning',
