...
class ProveedorController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($buscar == '')
        {
        	...
        	'personas.telefono','personas.direccion','personas.email','proveedores.contacto','proveedores.telefono_contacto')
    ...
    public function selectProveedor(Request $request)
    {
        ...
        ->select('personas.id','personas.nombre','personas.nombre','personas.num_documento')
    ...
    public function update(Request $request)
    {
        ...
        try {
        	DB::beginTransaction();
        	//Primero se debe buscar el Proveedor
